...
public abstract class Move {
    ...
    public Board execute() {
        ...
        for (final Piece picece : this.board.currentPlayer().getActivePieces()) {
            if (!this.movedPiece.equals(picece)) {
                builder.setPiece(picece);
            }
        }
    ...
    static abstract class CastleMove extends Move {
        ...
        protected final int casteRookDestination;
        public CastleMove(final Board board,
            ...
            this.casteRookDestination = castleRookDestination;
        }
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movedPiece(this));
            builder.setPiece(new Rook(this.castleRook.getPieceAlliance(), this.casteRookDestination));
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
        ...
        public int hashCode() {
            ...
            result = prime * result + this.casteRookDestination;
            return result;
        }
    ...
    public static final class NullMove extends  Move {
        ...
        @Override
        public Board execute() {
            throw new RuntimeException("Cannot execute run time move");
        }
    ...
    public static class MoveFactory {
        private MoveFactory() {
            throw new RuntimeException("Non instntiable!");
        }

        public static Move createMove(final Board board,
                                      final int currentCoordinate,
                                      final int destinationCoordinate) {
            for (final Move move : board.getAllianceMoves()) {
